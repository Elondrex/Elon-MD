...
ezra({ 
    ...
    const img = 'https://files.catbox.moe/d9xp1j.jpg';
    const imgs = 'https://files.catbox.moe/d9xp1j.jpg';
...
> @made by meshack matheka 2025\n`;
    ...
    try {
        await zk.sendMessage(dest, { 
            image: { url: "https://files.catbox.moe/d9xp1j.jpg" },
            caption: infoMsg + menuMsg,
            contextInfo: {
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: "120363418628641913@newsletter",
                    newsletterName: "Elon-MD",
                    serverMessageId: -1
                },
                forwardingScore: 999,
                externalAdReply: {
