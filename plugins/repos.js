...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/elonmusk02/Elon_md");
    const {
      name: _0x4ae93b,
