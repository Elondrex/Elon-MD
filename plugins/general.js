...
ezra({ nomCom: "dev", categorie: "luckymd-devs", reaction: "🚜" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Elondrex", numero: "2347018486818" },
      { nom: "freditech", numero: "255752593977" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "Uuhh Hello This Is Elon Md Dev Contacts:\n\n";
...
ezra({ nomCom: "support", categorie: "devs" }, async (dest, zk, commandeOptions) => {
  ...
  await zsendMessage(auteurMessage,{text :`https://whatsapp.com/channel/0029Vb6NIGDAe5Vs70fW703Z`},{quoted :ms})
...
ezra({ nomCom: "developer", categorie: "General", reaction: "🚜" }, async (dest, zk, commandeOptions) => {
    ...
    let message = " Hello👋 *Welcome to Elon md * here is the developer numbers:\n\n";
    for (const dev of devs) {
      message += `----------------\n• ${dev.nom} : https://wa.me/${dev.numero}\n`;
    }
  var lien = mybotpic()
